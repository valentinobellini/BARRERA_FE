...
// // larghezza viewport (allineata alle media query)
// function getViewportWidth() {
//     if (typeof window === 'undefined') return 1440;
//     const vv = window.visualViewport?.width;
//     return Math.round(vv || window.innerWidth || document.documentElement.clientWidth || 1440);
// }

// // breakpoint come nelle MQ: ≤600 → 1 card, ≤1220 → 2, oltre → 3
// function getVisibleByViewport(vw) {
//     if (vw <= 768) return 1;
//     if (vw <= 1220) return 2;
//     return 3;
// }
...
//     // misura viewport e aggiorna su resize/orientation
//     const [vw, setVw] = useState(() => getViewportWidth());
//     useEffect(() => {
//         let t;
//         const onResize = () => {
//             clearTimeout(t);
//             t = setTimeout(() => setVw(getViewportWidth()), 120);
//         };
//         window.addEventListener('resize', onResize);
//         window.addEventListener('orientationchange', onResize);
//         // misura subito (utile dopo mount/fonts)
//         onResize();
//         return () => {
...
//     const visible = useMemo(() => getVisibleByViewport(vw), [vw]);

//     // paginazione
//     const [page, setPage] = useState(0);
//     const totalPages = Math.ceil(reviews.length / visible) || 1;
...
//     // clamp pagina se cambia visible
//     useEffect(() => {
