    ...
    return (
        <motion.section className="porque-elegirme"
            ...
            <h2 className="porque-elegirme-title">
                Por qué Elegir a la Dra. Lucrecia Ceja como tu Médico Internista en Monterrey
            </h2>
            ...
            <section class="porque-elegirme-content">
                ...
                <h2>1. Trayectoria clínica sólida</h2>
                <ul>
                ...
                <h2>2. Credenciales y liderazgo profesional</h2>
                <ul>
                ...
                <h2>3. Confianza avalada por los pacientes</h2>
                <ul>
                ...
                <h2>4. Tecnología y enfoque integral</h2>
                <ul>
                ...
                <h2>5. Investigación y actualización continua</h2>
                <ul>
                ...
                <h2>6. Atención centrada en el paciente</h2>
                <ul>
                ...
                <h2>7. Ubicación y accesibilidad</h2>
                <ul>
